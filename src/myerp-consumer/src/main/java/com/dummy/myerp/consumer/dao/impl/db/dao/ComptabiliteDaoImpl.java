...
public class ComptabiliteDaoImpl extends AbstractDbConsumer implements ComptabiliteDao {
    ...
    private static String SQLgetSequenceEcritureComptableByJournalAndAnnee;
    public void setSQLgetSequenceEcritureComptableByJournalAndAnnee(String pSQLgetSequenceEcritureComptableByJournalAndAnnee) {
        SQLgetSequenceEcritureComptableByJournalAndAnnee = pSQLgetSequenceEcritureComptableByJournalAndAnnee;
    }
    @Override
    public SequenceEcritureComptable getSequenceEcritureComptableByJournalAndAnnee(String code, int annee) {
        NamedParameterJdbcTemplate vJdbcTemplate = new NamedParameterJdbcTemplate(getDataSource(DataSourcesEnum.MYERP));
        MapSqlParameterSource vSqlParams = new MapSqlParameterSource();
        vSqlParams.addValue("code", code);
        vSqlParams.addValue("annee", annee);
      SequenceEcritureComptableRM vRM = new  SequenceEcritureComptableRM();
       return vJdbcTemplate.query(SQLgetSequenceEcritureComptableByJournalAndAnnee, vSqlParams, vRM).stream().findFirst().orElse(null);

    }
//ToDO
    @Override
    public void insertOrUptadeSequenceEcritureComptable(SequenceEcritureComptable sequenceEcritureComptable) {
        NamedParameterJdbcTemplate vJdbcTemplate = new NamedParameterJdbcTemplate(getDataSource(DataSourcesEnum.MYERP));
        MapSqlParameterSource vSqlParams = new MapSqlParameterSource();
        vSqlParams.addValue("derniereValeur", sequenceEcritureComptable.getDerniereValeur());
