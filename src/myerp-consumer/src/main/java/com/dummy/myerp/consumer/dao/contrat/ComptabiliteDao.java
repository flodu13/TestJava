...
public interface ComptabiliteDao {
    ...
    SequenceEcritureComptable getSequenceEcritureComptableByJournalAndAnnee(String code, int annee);

    void insertOrUptadeSequenceEcritureComptable (SequenceEcritureComptable sequenceEcritureComptable);
